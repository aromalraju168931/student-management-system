...
SECRET_KEY = 'django-insecure-dxc=ndteaf$df6myv++etskb29g7t#b+mt(0!5zpbeudm-&cbp'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://postgres:postgre@aql@localhost:5432/student_db',
        conn_max_age=600
    )
}
...
CORS_ALLOWED_ORIGINS = [
    "https://student-management-system-three-eta.vercel.app",
]
